...
export default function HTMLPreview() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-t to-slate-500 from-zinc-500 items-center justify-center h-screen bg-background text-foreground">
      {/* Center the HTML previewer card within the screen */}
      <div className="w-full bg-slate-700 max-w-2xl p-6 rounded-lg shadow-lg bg-card">
